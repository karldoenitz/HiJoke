...
if [ $1 = "compile" ]; then
    echo "---start compile---"
    c++ main.cpp settings.cpp Utils/Utils.cpp DatabaseManager/DatabaseOperator.cpp DatabaseManager/joke/bean/Joke.cpp DatabaseManager/joke/manager/JokeManager.cpp DatabaseManager/user/bean/User.cpp DatabaseManager/comment/bean/Comment.cpp DatabaseManager/comment/manager/CommentManager.cpp DatabaseManager/user/manager/UserManager.cpp Application/BaseHandler.cpp Application/login/LoginHandler.cpp Application/logout/LogoutHandler.cpp Application/register/RegisterHandler.cpp Application/joke/JokeHandler.cpp Application/comment/CommentHandler.cpp Templates/views.cpp -o main.o -lcppcms -lcppdb -lbooster -std=c++11
